...
public class S3Config {
  ...
  @Bean
  public S3Presigner s3Presigner(Region region, AwsCredentialsProvider provider) {
    return S3Presigner.builder().region(region).credentialsProvider(provider).build();
  }
}
