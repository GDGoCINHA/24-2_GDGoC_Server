...
public class QuestionController {
    ...
    public ApiResponse<Long> createQuestion(@RequestBody QuestionRequestDto questionRequestDto) {
        Question savedQuestion = questionService.save(questionRequestDto);
